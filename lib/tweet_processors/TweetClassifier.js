...
var fs = require('fs');
var stopList = fs.readFileSync('stop_list.txt').toString().split('\n');
...
if (fs.existsSync(weightsFile)) {
  ...
  var transferTweets = fs.readFileSync('./transferTweets.csv')
                              .toString().split('\n');
  var footballTweets = fs.readFileSync('./footballTweets.csv')
                              .toString().split('\n');
